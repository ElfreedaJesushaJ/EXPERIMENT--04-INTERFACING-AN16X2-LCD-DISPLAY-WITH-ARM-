...
int main(void)
{
  ...
  Lcd_PortType ports[] = { GPIOA, GPIOA, GPIOA, GPIOA };
     ...
     Lcd_cursor(&lcd, 0,1);
     Lcd_string(&lcd, "Elfreeda Jesusha J");
     Lcd_cursor(&lcd, 1,1);
     Lcd_string(&lcd, "212224040084");
  /* USER CODE END 2 */
...
## Output screen shots of proteus  :
 ![Screenshot 2025-04-11 085234](https://github.com/user-attachments/assets/9f3348a3-ca98-464d-8065-493c2d4811ce)
